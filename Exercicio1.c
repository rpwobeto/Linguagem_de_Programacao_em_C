...
/* O exercício 1 apresenta as seguintes informações:
...
int main(){
    ...
    // Inserir os dados manualmente no sistema
    ...
    // verificar as alíquotas por meio do ponteiro desenvolvido
    ...
    printf("\nSalario apos o desconto do imposto: %.2f", ((*p).salario)-imposto);
